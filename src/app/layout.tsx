...
export const metadata: Metadata = {
  ...
  description: "Create stunning, high-quality images with Genova AI's advanced artificial intelligence technology.",
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="scroll-smooth">
      ...
      <body className={`${geist.variable} font-sans antialiased min-h-screen flex flex-col bg-gray-900`}>
